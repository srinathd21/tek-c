...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* ✅ Make BRAND CARD same width as feature cards */
    .brand {
      display: flex;
      align-items: center;
      gap: 12px;
      ...
      width: 100%;
      /* ✅ same full length like feature cards */
      max-width: 760px;
    ...
    /* ✅ Make LOGO BOX same size as feature icons */
    .brand .logo {
      width: 46px;
      height: 46px;
      /* ✅ same as .feature .ic */
    ...
    /* icon background same as left yellow */
    .feature .ic {
      width: 46px;
      height: 46px;
      border-radius: 16px;
      ...
      <div class="left-inner">
        ...
        <div class="feature">
          ...
          <div>
            ...
            <p class="fd">Track project scope, site details, agreements, work orders, and all related documents in one
              place.</p>
          </div>
        </div>
        ...
        <div class="feature">
          ...
          <div>
            ...
            <p class="fd">
              Tailored access for Admin, HR, QS, Accounts, Project Managers, Team Leads, and Site Engineers—ensuring
              clarity,
        ...
        <div class="feature" style="margin-bottom:0;">
          ...
          <div>
            ...
            <p class="fd">Securely store and manage staff records, site photos, drawings, approvals, and all critical
              project documents.</p>
          </div>
        </div>
      </div>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <span class="input-group-text"
                style="border-radius:12px 0 0 12px; border:2px solid #e5e7eb; border-right:none; background:#fff;">
                <i class="bi bi-person"></i>
              </span>
              <input type="text" class="form-control" id="username" name="username"
                value="<?php echo e($_POST['username'] ?? ''); ?>" placeholder="Enter username" required
