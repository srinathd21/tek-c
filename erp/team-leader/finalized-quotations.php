        ...
        <div id="contentScroll" class="content-scroll">
            <div class="container-fluid maxw">
                    ...
                    <div class="col-12 col-md-6 col-xl-3">
                        <div class="stat-card">
                            ...
                            <div>
                                ...
                                <div class="stat-value"><?php echo (int)$total_finalized; ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xl-3">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-label">QS Finalized</div>
                                <div class="stat-value"><?php echo (int)$total_finalized; ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stat-card">
                            ...
                            <div>
                                ...
                                <div class="stat-value"><?php echo formatCurrency($total_savings); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="alert alert-info alert-dismissible fade show mb-3" role="alert">
                    ...
                    No finalized quotations yet. QS team will finalize negotiations and you'll see them here.
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
                <?php endif; ?>
                ...
                <div class="panel mb-4">
                    <div class="panel-header">
                        <h3 class="panel-title">Finalized & Ready for Approval</h3>
                        ...
                        <div class="d-grid gap-3">
                            <?php if (empty($requests)): ?>
                                <div class="text-center py-4 text-muted">
                                    ...
                                    <p class="mt-2 fw-bold">No finalized quotations</p>
                                    <p class="small">Finalized quotations will appear here for manager approval.</p>
                                </div>
                            <?php else: ?>
                                    ...
                                    <div class="request-card <?php echo $cardClass; ?>">
                                        ...
                                        <div class="mb-2">
                                            <span class="finalized-badge">
                                                <i class="bi bi-check-circle"></i> Finalized: <?php echo formatCurrency($req['finalized_amount']); ?>
                                            </span>
                                            <?php if ($savings > 0): ?>
                                                <span class="savings-badge ms-1">
                                                    <i class="bi bi-piggy-bank"></i> Saved <?php echo formatCurrency($savings); ?>
                                                </span>
                                            <?php endif; ?>
                                        ...
                                        <div class="request-kv mt-2">
                                            ...
                                            <div class="request-row">
                                                <div class="request-key">Finalized On</div>
                                                <div class="request-val">
                                                    <?php echo safeDate($req['finalized_at'] ?? $req['updated_at']); ?>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="d-flex gap-3">
                                ...
                                <div>
                                    <h6 class="fw-900 mb-1">QS Finalized</h6>
                                    <p class="small text-muted mb-0">QS team has finalized the best quotation after negotiation.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex gap-3">
                                ...
                                <div>
                                    <h6 class="fw-900 mb-1">Awaiting Manager Approval</h6>
                                    <p class="small text-muted mb-0">Manager will review and make final decision.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex gap-3">
                                ...
                                <div>
                                    <h6 class="fw-900 mb-1">Final Approval</h6>
                                    <p class="small text-muted mb-0">Once approved, purchase order will be issued.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
        ...
        if (isDesktop) {
            if (!$.fn.DataTable.isDataTable('#finalizedTable')) {
                $('#finalizedTable').DataTable({
                    ...
                    order: [[8, 'desc']], // Sort by finalized date
                    columnDefs: [
                        { targets: [11], orderable: false, searchable: false } // Action column
                    ],
                    language: {
                        zeroRecords: "No finalized quotations found",
            ...
            if ($.fn.DataTable.isDataTable('#finalizedTable')) {
                $('#finalizedTable').DataTable().destroy();
            }
        }
    }
    ...
    $(function () {
        initFinalizedTable();
        window.addEventListener('resize', initFinalizedTable);
    });
</script>
