...
<body>
            ...
            <div id="contentScroll" class="content-scroll">
                <div class="container-fluid projects-wrapper px-0">
                    ...
                    <div class="page-heading">
                        <div>
                            <h1>Apply Leave</h1>
                            <p>Submit leave request and route approval by hierarchy: Project Engineer → TL, TL →
                                Manager, Manager/HR → Admin.</p>
                        </div>
                    ...
                    <div class="row g-3">
                                ...
                                <div class="panel">
                                    <div class="panel-header">
                                        <div>
                                            ...
                                            <div class="panel-subtitle">Choose project, leave type and handover details
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-7">
                                            <label class="form-label">Project / Site <span
                        ...
                        ?>
                                                <option value="<?php echo $projectId; ?>"
                                                    <?php echo ($selectedSiteId === $projectId ? 'selected' : ''); ?>>
                                            ...
                                            <div class="form-helper">
                                                ...
                                                Approval route is hierarchy based: Project Engineer → TL, TL → Manager,
                                                Manager/HR → Admin. TL users will see the project manager name beside
                                                each project.
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <select class="form-select" name="leave_type" id="leave_type" required>
                                                <option value="CL" <?php echo ($leaveType==='CL'?'selected':''); ?>>
                                                    Casual Leave (CL) - <?php echo e($leaveBalance['CL']); ?> left
                                                </option>
                                                <option value="SL" <?php echo ($leaveType==='SL'?'selected':''); ?>>Sick
                                                    Leave (SL) - <?php echo e($leaveBalance['SL']); ?> left</option>
                                                <option value="EL" <?php echo ($leaveType==='EL'?'selected':''); ?>>
                                                    Earned Leave (EL) - <?php echo e($leaveBalance['EL']); ?> left
                                                </option>
                                                <option value="LOP" <?php echo ($leaveType==='LOP'?'selected':''); ?>>
                                                    Loss of Pay (LOP)</option>
                                                <option value="OD" <?php echo ($leaveType==='OD'?'selected':''); ?>>On
                                                    Duty (OD)</option>
                                                <option value="WFH" <?php echo ($leaveType==='WFH'?'selected':''); ?>>
                                                    Work From Home (WFH) - <?php echo e($leaveBalance['WFH']); ?> left
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    <input class="form-control" id="from_date_view" readonly
                                                        placeholder="From Date" style="background:#f8fafc;">
                                                </div>
                                                <div class="col-6">
                                                    <input class="form-control" id="to_date_view" readonly
                                                        placeholder="To Date" style="background:#f8fafc;">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input class="form-control" name="contact_during_leave"
                                                value="<?php echo e($contactDuringLeave); ?>"
                                                placeholder="Mobile / email">
                                        </div>

                                        <div class="col-md-3">
                                            <label class="form-label">Handover To</label>
                                            <input class="form-control" name="handover_to"
                                                value="<?php echo e($handoverTo); ?>" placeholder="Employee name">
                                        </div>

                                        <div class="col-12">
                                            <label class="form-label">Reason <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="reason" required
                                                placeholder="Enter detailed reason for leave"><?php echo e($reason); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel">
                                    <div class="panel-header">
                                        <div>
                                            ...
                                            <div class="panel-subtitle">Click start date and end date to select a range
                                            </div>
                                        </div>
                                    ...
                                    <div class="calendar-container">
                                        <div class="calendar-header">
                                            ...
                                            <h6 class="calendar-title" id="calendarTitle">
                                                <?php echo e($firstDay->format('F Y')); ?></h6>
                                ...
                                <div class="panel">
                                    <div class="panel-header">
                                        <div>
                                            ...
                                            <div class="panel-subtitle">Mark specific days as first half or second half
                                                if needed</div>
                                        </div>
                                    </div>

                                    <div id="selectedList" class="selected-dates-list">
                                        <div class="text-center text-muted py-4">No dates selected. Click on calendar
                                            dates to select.</div>
                                    </div>

                                    <div class="submit-row">
                                        <div class="table-secondary-text">
                                            Create action will be stored in <b>activity_logs</b> and a notification will
                                            be sent to the approver.
                                        </div>

                                        <button type="submit" class="primary-btn"
                                            <?php echo empty($myProjects) ? 'disabled' : ''; ?>>
                            ...
                            <div class="panel">
                                <div class="panel-header">
                                    <div>
                                        ...
                                        <div class="panel-subtitle">How the selected project notification is routed
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel">
                                <div class="panel-header">
                                    <div>
                                        ...
                                        <div class="panel-subtitle">Only projects under this employee are available
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <td data-label="Project">
                                                    <div class="table-title-cell">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="table-secondary-text">
                                                                <?php echo e($p['project_location'] ?? ''); ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                        ...
                                        <div class="d-flex justify-content-between gap-2 align-items-start">
                                            <div>
                                                ...
                                                <div class="table-secondary-text mt-1">
                                                    <?php echo e($r['total_days']); ?> day(s) •
                                                    <?php echo e(safeDate($r['applied_at'])); ?>
                                                </div>
                                            </div>
    ...
    function renderSelectedList() {
        ...
        selectedDates.forEach(date => {
            ...
            const dayName = parsedDate ? parsedDate.toLocaleDateString('en-US', {
                weekday: 'long'
            }) : '';
