                        ...
                        <div class="panel">
                            <div class="profile-card">
                                <div class="avatar-lg">
                                    ...
                                    <?php else: ?>
                                    <span
                                        class="fw-bold"><?php echo e(strtoupper(substr($emp['full_name'], 0, 1))); ?></span>
                                    <?php endif; ?>
                                </div>
                                <div>
                                    ...
                                    <div class="mt-2 d-flex flex-wrap gap-2">
                                        <span class="chip"><i
                                                class="bi bi-person-badge"></i><?php echo e($emp['designation'] ?? ''); ?></span>
                                        <span class="chip"><i
                                                class="bi bi-hash"></i><?php echo e($emp['employee_code'] ?? ''); ?></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select class="form-select" name="gender">
                                            ...
                                            <option value="Other" <?php echo $g==='Other'?'selected':''; ?>>Other
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="blood_group"
                                            value="<?php echo e($emp['blood_group'] ?? ''); ?>"
                                            placeholder="A+, O+, ...">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="emergency_contact_phone"
                                            value="<?php echo e($emp['emergency_contact_phone'] ?? ''); ?>"
                                            maxlength="15">
                                    </div>
                                </div>
