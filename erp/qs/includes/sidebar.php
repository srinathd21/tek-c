...
<aside id="sidebar" class="sidebar" aria-label="Sidebar">
    ...
    <div class="nav-section">
        ...
        <div class="collapse ps-2 side-submenu-collapse" id="quotationMenu">
            ...
            <a class="side-link sub-link" href="dealers-directory.php">
                <i class="bi bi-clock-history"></i>
    ...
    <div class="side-submenu" id="mailMenu" hidden>
      ...
      <i class="bi bi-file-earmark-text"></i><span class="label">Reports</span>
        ...
        <!-- HR -->
        <button class="side-link side-toggle" type="button" id="hrToggle" aria-expanded="false" aria-controls="hrMenu"
            title="HR">
...
#sidebar.collapsed #mailMenu {
    top: var(--mail-top, 60px);
}

#sidebar.collapsed #tmMenu {
    top: var(--tm-top, 120px);
}

#sidebar.collapsed #hrMenu {
    top: var(--hr-top, 180px);
}
