...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'submit_regularization') {
        ...
        // Get approver details from selected site: Project TL first, then Project Manager
        $manager_id = null;
        $manager_name = '';
        $approver_source = '';
       ...
       OR LOWER(COALESCE(ptl.designation,'')) LIKE '%lead%'
            ...
            if ($site_manager) {
                ...
                if (in_array($currentRoleKey, ['manager', 'hr'], true)) {
                ...
                <div class="container-fluid projects-wrapper px-0">
                    ...
                    <div class="page-heading">
                        <div>
                            ...
                            <p>Request corrections for missed or incorrect punch entries under your assigned project.
                            </p>
                        </div>
                    ...
                    <div class="alert alert-<?php echo e($message_type); ?> alert-dismissible fade show" role="alert">
                        <i
                            class="bi bi-<?php echo $message_type === 'success' ? 'check-circle-fill' : 'exclamation-triangle-fill'; ?> me-2"></i>
                        <?php echo $message; ?>
                        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                    <?php endif; ?>
                        ...
                        <div class="col-12 col-sm-6 col-xl-3">
                            <div class="stat-card">
                                ...
                                <div>
                                    ...
                                    <div class="stat-value"><?php echo count($assigned_sites); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel">
                                <div class="panel-header">
                                    <div>
                                        ...
                                        <div class="panel-subtitle">Select project, date, correction type and requested
                                            time</div>
                                    </div>
                                ...
                                <form method="POST" enctype="multipart/form-data" id="regularizationForm">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <select name="selected_site_id" class="form-select" id="selected_site"
                                                required onchange="updateManagerInfo()">
                                                ...
                                                <?php
                                                    ...
                                                    } elseif (in_array($currentRoleKey, ['manager', 'hr'], true)) {
                                                        $routeName = 'Admin';
                                                        $routeLabel = 'Admin';
                                                    }
                                                ?>
                                                <option value="<?php echo (int)$site['id']; ?>"
                                                    ...
                                                    <?php echo e($routeLabel . ': ' . $routeName); ?><?php endif; ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                            ...
                                            <div class="form-hint text-danger">
                                                No projects assigned. Please contact HR.
                                            </div>
                                            <?php else: ?>
                                            <div class="form-hint">
                                                Approval route is hierarchy based: Project Engineer → TL, TL → Manager,
                                                Manager/HR → Admin. TL users will see the manager name beside each
                                                project.
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="attendance_date" class="form-control"
                                                id="attendance_date" max="<?php echo date('Y-m-d'); ?>"
                                                min="<?php echo date('Y-m-d', strtotime('-30 days')); ?>" required
                                                onchange="loadAttendanceData(this.value)">
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label">Request Type <span
                                                    class="text-danger">*</span></label>
                                            <select name="request_type" class="form-select" id="request_type" required
                                        ...
                                        <div class="col-md-6" id="punch_out_field" style="display:none;">
                                            ...
                                            <input type="time" name="requested_punch_out" class="form-control"
                                                id="requested_punch_out" step="60">
                                            <div class="form-hint">Format: HH:MM</div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="reason" class="form-control" rows="3" required
                                                placeholder="Please provide detailed reason for this request..."></textarea>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-hint">Accepted formats: PDF, JPG, PNG, DOC. Max size
                                                depends on server upload setting.</div>
                                        </div>
                                    </div>

                                    <div class="submit-row">
                                        <div class="table-secondary-text">
                                            Create action is stored in <b>activity_logs</b> and notification is sent to
                                            the approver.
                                        </div>

                                        <button type="submit" class="primary-btn"
                                            <?php echo empty($assigned_sites) ? 'disabled' : ''; ?>>
                                    ...
                                    <table class="table compact-table align-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="table-title-cell">
                                                        ...
                                                        <div>
                                                            <div class="table-primary-text">
                                                                <?php echo e($req['request_no'] ?? '—'); ?></div>
                                                            <div class="table-secondary-text reason-cell">
                                                                <?php echo e($req['reason'] ?? '—'); ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td data-label="Date">
                                                    <div class="table-primary-text">
                                                        <?php echo e(safeDate($req['attendance_date'] ?? '')); ?></div>
                                                </td>
                                                ...
                                                <td data-label="Current">
                                                    <div class="table-secondary-text"><?php echo e($current_time); ?>
                                                    </div>
                                                </td>

                                                <td data-label="Requested">
                                                    <div class="table-primary-text"><?php echo e($requested_time); ?>
                                                    </div>
                                                </td>
                                                ...
                                                <td data-label="Submitted">
                                                    <div class="table-secondary-text">
                                                        <?php echo e(safeDate($req['created_at'] ?? '')); ?></div>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                            <?php endif; ?>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <div class="panel text-center">
                                        ...
                                        <p class="small text-muted mb-0">Allowed only for dates within the last 30 days.
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="panel text-center">
                                        ...
                                        <p class="small text-muted mb-0">Requests are usually processed in 2-3 business
                                            days.</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="panel text-center">
                                        ...
                                        <p class="small text-muted mb-0">Project Engineer → TL, TL → Manager, Manager/HR
                                            → Admin.</p>
                                    </div>
                                </div>
                            </div>
