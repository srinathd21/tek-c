...
// Get manager's assigned sites/projects
$sites_query = "SELECT s.id, s.project_name, s.project_code, s.project_location, 
                       s.project_type, s.start_date, s.expected_completion_date,
...
if ($stmt) {
    ...
    // Validate preselected site belongs to this manager
...
// Get recent quotation requests for this manager
        ...
        <div class="container-fluid maxw">
          ...
          <div class="panel">
            <form id="quotationRequestForm" method="POST" action="process-quotation-request.php" enctype="multipart/form-data">
              ...
              <!-- Budget & Quantity Section (Optional) -->
              <div class="form-section">
                <div class="form-section-title">
                  <i class="bi bi-calculator"></i> Budget & Quantity (Optional)
                </div>
                ...
                <div class="row g-3">
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control border-start-0" name="estimated_budget" placeholder="0.00" step="0.01" style="border-left:0; padding-left:0;">
                    </div>
                  </div>

                  <div class="col-md-4">
                    <label class="form-label">Quantity (if applicable)</label>
                    <input type="number" class="form-control" name="quantity" placeholder="e.g., 100" step="0.01">
                  </div>

                  <div class="col-md-4">
                    <label class="form-label">Unit</label>
                    <input type="text" class="form-control" name="unit" placeholder="e.g., sq.m, kg, pieces">
                  </div>
                </div>
              </div>
