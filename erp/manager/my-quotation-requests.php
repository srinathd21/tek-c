<?php
// my-quotation-requests.php (Manager) — show ALL quotation requests created by logged-in manager
...
// ---------- Fetch all quotation requests for this manager ----------
$sql = "
  SELECT 
    qr.*,
    s.project_name,
      ...
      <div class="container-fluid maxw">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
          <div>
            ...
            <p class="text-muted mb-0">All quotation requests created by you</p>
          </div>
          <div>
                  ...
                  <div class="request-card">
                    ...
                    <div class="request-actions">
                      ...
                      <?php if ($req['status'] === 'Draft'): ?>
                        <a href="quotation-requests.php?edit=<?php echo $req['id']; ?>" class="btn-action quotation" title="Edit">
                ...
                <?php foreach ($requests as $req): ?>
                  <tr>
                    ...
                    <td class="text-end actions-col">
                      ...
                      <?php if ($req['status'] === 'Draft'): ?>
                        <a href="quotation-requests.php?edit=<?php echo $req['id']; ?>" class="btn-action quotation" title="Edit Draft">
