...
$currentRoleLabel = $isHr ? 'HR' : ($isAdmin ? 'Admin' : 'Manager');
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <style>
        ...
        .primary-btn,.secondary-btn,.btn-action,.success-btn,.danger-btn{
            min-height:36px;
            padding:0 14px;
            border-radius:11px;
            font-size:12px;
        ...
        .btn-action.view:hover,.btn-action.people:hover{
            color:#2563eb;
            border-color:#bfdbfe;
            background:#eff6ff;
        }
