                ...
                ?>
                                ...
                                <div>
                                    ...
                                    <p class="employee-meta">
                                        <span
                                            class="mini-chip"><?php echo e($employee['employee_code'] ?? ''); ?></span>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        ...
                                        <div class="d-flex align-items-baseline gap-2">
                                            <div class="punch-time-compact" id="currentTime">
                                                <?php echo e($current_time); ?></div>
                                            <div class="punch-date-compact" id="currentDate">
                                                <?php echo e(date('D, d M Y')); ?></div>
                                        </div>
                                        <?php if ($can_punch_office): ?>
                                        <div class="punch-date-compact mt-2"><i class="bi bi-shield-check"></i> Office
                                            punching enabled for your role</div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="col-md-4 text-md-end mt-3 mt-md-0">
                                        ...
                                        <span class="status-badge status-white" style="font-size:9px;">
                                            ...
                                            <?php echo e($attendance['total_hours'] ?? '0'); ?>h
                                        </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                        <td data-label="Date">
                                            <div class="proj-title">
                                                <?php echo e(date('d M Y', strtotime($hist['attendance_date']))); ?>
                                            </div>
                                        </td>
                                        <td data-label="Punch In">
                                            <div class="proj-title">
                                                <?php echo e(safeTimeOnly($hist['punch_in_time'] ?? '', '—')); ?></div>
                                        </td>
                                        <td data-label="Punch Out">
                                            <div class="proj-title">
                                                <?php echo !empty($hist['punch_out_time']) ? e(safeTimeOnly($hist['punch_out_time'])) : '—'; ?>
                                            </div>
                                        </td>
                                        <td data-label="Hours">
                                        ...
                                        <td data-label="Location">
                                            ...
                                            <span class="mini-chip">
                                                <i
                                                    class="bi bi-<?php echo ($atype === 'site') ? 'building' : 'briefcase'; ?>"></i>
