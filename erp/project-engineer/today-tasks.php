...
// ---------------- Report Types ----------------
// ONLY DPR, DAR, CHECKLIST ARE SHOWN
$reportTypes = [
  [
    'key' => 'dpr',
    'label' => 'Daily DPR',
...
if (tableExists($conn, 'employee_report_remarks')) {
  $sql = "
    ...
    WHERE report_date = ?
      AND employee_id = ?
      AND report_key IN ('dpr', 'dar', 'checklist')
  ";
    ...
    <div id="contentScroll" class="content-scroll">
      <div class="container-fluid maxw">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
          <div>
            <h1 class="h-title">Daily logs</h1>
            <p class="h-sub">
              Today DPR, DAR and Checklist status for <?php echo e(date('d M Y')); ?> 
              (<?php echo e($todayYmd); ?>)

              <?php if ($filterSiteId > 0 && !empty($sites[0])): ?>
                • <span class="small-muted">
                  Filtered Site:
                  <b style="color:#111827;"><?php echo e($sites[0]['project_name']); ?></b>
                </span>
              <?php endif; ?>
            </p>
          </div>
          ...
          <div class="d-flex gap-2 flex-wrap">
            ...
            <a 
              class="btn-action" 
              href="employee-pending-tasks.php<?php echo $filterSiteId > 0 ? ('?site_id=' . e($filterSiteId)) : ''; ?>" 
              title="Refresh"
            >
          ...
          <div class="col-12 col-md-6 col-xl-3">
            <div class="stat-card">
              ...
              <div>
                ...
                <div class="small-muted">Today DPR / DAR / Checklist</div>
              </div>
            </div>
          </div>
        ...
        <div class="panel">
          <div style="font-weight:1000; font-size:14px; color:#111827;">
            My Projects — Today DPR / DAR / Checklist
          </div>

          <div class="small-muted">
            Only today DPR, DAR and Checklist pending/completed reports are shown below.
          </div>
          ...
          <?php else: ?>
            ...
            <div class="d-none d-md-block">
                  ...
                  <tbody>
                    <?php $i = 1; foreach ($taskRows as $row): ?>
                      <tr>
                        ...
                        <td style="font-weight:1000; color:#111827;">
                          <?php echo e($row['project_name']); ?>
                        </td>
              ...
              <div class="small-muted mt-2">
                Note: Only today DPR, DAR and Checklist reports are listed.
              </div>
            </div>
