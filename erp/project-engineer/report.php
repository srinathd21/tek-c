...
<head>
  ...
  <style>
    ...
    .r-actions .btn{ width:100%; border-radius:12px; font-weight:900; }
          ...
          <div class="d-block d-md-none">
            <div class="d-grid gap-3">
              <?php if (empty($reports)): ?>
                <div class="text-muted fw-bold">No reports found.</div>
              <?php else: ?>
                <?php foreach ($reports as $r): ?>
                  <?php
                    ...
                    $canShowEdit = false;
                    if ($rtype === 'DPR' && $editStatus === 1) $canShowEdit = true;
                    ...
                    $qs['view'] = $rid;
                    $qs['view_type'] = $rtype;
                    $viewUrl = 'report.php?' . http_build_query($qs);
                  ?>
                  ...
                  <div class="r-card">
                    <div class="top">
                      <div>
                        ...
                        <div class="mt-2" style="font-weight:1000; font-size:14px;">
                          <?php echo e($r['report_no']); ?>
                        </div>
                        <div class="small-muted mt-1">
                          <i class="bi bi-calendar-event"></i> <?php echo e(safeDate($r['report_date'])); ?>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="r-kv">
                      <div class="r-row">
                        <div class="r-key">Project</div>
                        <div class="r-val">
                          <?php echo e($r['project_name']); ?><br>
                          <span class="small-muted"><i class="bi bi-geo-alt"></i> <?php echo e($r['project_location']); ?> • <?php echo e($r['project_type']); ?></span>
                        </div>
                      </div>
                      <div class="r-row">
                        <div class="r-key">Client</div>
                        <div class="r-val"><?php echo e($r['client_name']); ?></div>
                      </div>
                      <div class="r-row">
                        <div class="r-key">Info</div>
                        <div class="r-val"><?php echo e($extra); ?></div>
                      </div>
                      <div class="r-row">
                        <div class="r-key">Prepared</div>
                        <div class="r-val"><?php echo e($r['prepared_by']); ?></div>
                      </div>
                    </div>

                    <div class="r-actions">
                      <a class="btn btn-outline-primary" href="<?php echo e($viewUrl); ?>">
                        <i class="bi bi-eye"></i> Report
                      </a>

                      <?php if ($canShowEdit): ?>
                        <a class="btn btn-outline-warning" href="dpr.php?edit_id=<?php echo (int)$rid; ?>">
                          <i class="bi bi-pencil-square"></i> Edit
                        </a>
                      <?php endif; ?>

                      <?php if ($rtype === 'DPR' && $designation === 'manager'): ?>
                        <form method="POST" action="report.php<?php echo !empty($_GET) ? ('?' . e(http_build_query($_GET))) : ''; ?>">
                          ...
                          <button type="submit"
                                  class="btn <?php echo $editStatus === 1 ? 'btn-outline-danger' : 'btn-outline-success'; ?>">
                      ...
                      <a class="btn btn-outline-dark" href="<?php echo e($viewPdfUrl); ?>" target="_blank" rel="noopener noreferrer">
                        <i class="bi bi-printer"></i> Print
                      </a>

                      <a class="btn btn-outline-success" href="<?php echo e($downloadPdfUrl); ?>" rel="noopener noreferrer">
...
<script>
  ...
  function initReportTable() {
    ...
    if (isDesktop) {
      ...
      // if someone resized from desktop to mobile, destroy datatable cleanly
      if ($.fn.DataTable.isDataTable('#reportTable')) {
  ...
  $(function(){
    initReportTable();
    window.addEventListener('resize', initReportTable);
  });
