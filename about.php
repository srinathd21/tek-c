...
.problem-card li i{color:var(--red);}
.solution-card li i{color:var(--green);}
...
.diff-card.last{border-right:none;}
...
.vision-blue{background:#eef6ff;}
.vision-orange{background:#fff4ea;}
.vision-purple{background:#f6efff;}
...
@media(max-width:991px){
    ...
    .solution-device{display:none;}
    .vision-card p{max-width:100%;}
    .vision-card img{opacity:.22;}
    .diff-card{border-right:none;border-bottom:1px solid #eee;}
}
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7" data-aos="fade-right">
                ...
                <h1>Built from Real Sites. Designed for <span class="text-yellow">Total Control.</span></h1>
                <p>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-4" data-aos="fade-right">
                <img src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&w=900&q=80" class="story-img" alt="Construction project">
            </div>

            <div class="col-lg-5 story-content" data-aos="fade-up">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7" data-aos="fade-left">
                <div class="solution-card">
                    ...
                    <ul class="list-clean">
                        <li><i class="fa-solid fa-circle-check"></i> Structured daily reporting (DPR / MOM / RFI)</li>
                    ...
                    <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=600&q=80" class="solution-device" alt="Dashboard">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            <div class="col-lg-4" data-aos="fade-up">
                <div class="vision-card vision-blue">
                    ...
                    <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=700&q=80" alt="">
                </div>
            </div>
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="vision-card vision-orange">
                    ...
                    <img src="https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=700&q=80" alt="">
                </div>
            </div>
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="vision-card vision-purple">
                    ...
                    <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=700&q=80" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="lower-info">
    <div class="container">
        <div class="row g-4 align-items-stretch">
            <div class="col-lg-4" data-aos="fade-right">
                <div class="eco-card">
                    <div class="small-label">Who We Serve</div>
                    <h3 class="fw-bold">Built for the Entire<br>Construction Ecosystem.</h3>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="practice-grid">
                                <img src="https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=400&q=80" alt="">
                                <img src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&w=400&q=80" alt="">
                                <img src="https://images.unsplash.com/photo-1590650046871-92c887180603?auto=format&fit=crop&w=400&q=80" alt="">
                                <img src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=400&q=80" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center g-4">
            <div class="col-lg-6" data-aos="fade-right">
                <h2>Ready to Experience<br>Structured Project Management?</h2>
